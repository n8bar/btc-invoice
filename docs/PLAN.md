...
- Status: `active`
- Next action: begin MS14 with the Phase 14.1 / Slice 1 foundation work from the strategy doc: add key-lineage schema (`wallet_key_cursors` plus invoice key snapshot columns) before changing watcher behavior.
