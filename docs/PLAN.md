...
13. **UX Overhaul**
    ...
    - [ ] Public/share layout refresh to mirror updated show/print patterns; friendly disabled/expired states.
      - Sequencing note (2026-02-21): Task 10 implementation subitems remain tracked in ToDo with completed checks preserved, but final Task 10 acceptance is gated on closing Task 9 (ToDo) first.
