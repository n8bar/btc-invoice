...
- Status: `active`
- Next action: continue MS14 Phase 3 with `3.3 Detect unsupported cases from invoice/payment evidence`, building on the new wallet-save proactive detection from `3.2`.
