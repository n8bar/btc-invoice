...
#### 14.1.1 Schema + model foundation
...
#### 14.1.2 Wallet save + invoice create behavior
...
#### 14.1.4 Backfill and recovery support
...
#### 14.2.2 Onboarding reinforcement
...
#### 14.2.3 Guardrails and telemetry
...
#### 14.3.3 Safeguards and auditability
...
- Mitigation: ship in the phased order above, with focused tests and dry-run command checks at each step.
