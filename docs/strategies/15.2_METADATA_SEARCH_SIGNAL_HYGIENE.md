...
4. [ ] If Phase 1 says the current one-page/public Helpful Notes mix is too thin, allow derivative public Helpful Notes content under `site/` only to the extent needed to strengthen SEO while the site still reads as a product placeholder.
...
4. [ ] If derivative public Helpful Notes content is needed, add only as much as materially improves SEO coverage without turning the placeholder into a broad knowledge base.
...
3. [ ] Note any SEO-related changes that later rollout work must preserve at go-live.
...
4. [ ] Confirm any later rollout constraints discovered here are captured at the right higher level instead of being rediscovered at deployment time.
5. [ ] If derivative public Helpful Notes content shipped, confirm it improves SEO coverage while the site still reads as a product placeholder rather than a docs encyclopedia.
