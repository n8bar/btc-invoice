...
7. **Custom Outbound Mail Logo Uploads**
...
13. **Advanced payment-ledger admin tooling**
...
## Content & SEO
14. **CMS-style Help Center (public)**
...
## Product UX
15. **Multi-wallet selection + additional wallets UI**
...
16. **Quotes + quote-to-invoice conversion**
...
17. **Client balance tracking + credits**
...
18. **Spending-only companion wallet ecosystem idea**
