...
2. Automatically send a paid receipt email once the watcher marks an invoice paid.
3. Ensure both owners and clients receive email alerts for key invoice events without relying on manual follow-up.
