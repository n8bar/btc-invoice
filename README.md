...
- **Placeholder site:** The temporary GitHub Pages placeholder for `cryptozing.app` lives under `site/` and is intended to deploy separately from the Laravel app surface.
