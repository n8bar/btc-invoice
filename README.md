...
- MS15 Phase 3 strategy: [`docs/strategies/15.3_CONTINUITY_LAUNCH_HANDOFF.md`](docs/strategies/15.3_CONTINUITY_LAUNCH_HANDOFF.md)
- MS15 Phase 4 strategy: [`docs/strategies/15.4_VERIFICATION_MONITORING.md`](docs/strategies/15.4_VERIFICATION_MONITORING.md)
