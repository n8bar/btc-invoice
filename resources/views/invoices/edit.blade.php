        ...
        <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('invoices.update', $invoice) }}" class="space-y-6">
                ...
                @php
                    ...
                    $brandingHasValues = collect($brandingFieldNames)->contains(function ($field) use ($invoice) {
                        return filled(old($field, $invoice->{$field} ?? null));
                    });
                    $brandingOpen = $brandingHasErrors || $brandingHasValues;
                @endphp
