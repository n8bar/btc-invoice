                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <button type="submit"
                                        class="block w-full px-4 py-2 text-start text-sm leading-5 text-gray-700 hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 transition duration-150 ease-in-out dark:text-slate-100 dark:hover:bg-white/10 dark:focus-visible:ring-offset-slate-900">
                                    {{ __('Log out') }}
                                </button>
                            </form>
                        </x-slot>
