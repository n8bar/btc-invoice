                    ...
                    <form method="POST" action="{{ route('settings.notifications.update') }}" class="space-y-6">
                        ...
                        <div class="rounded-lg border border-gray-200 bg-white p-4 space-y-4">
                            ...
                            <p class="text-xs text-gray-600">
                                Control automatic client receipt delivery after invoices are paid. Ambiguous payment states may still require invoice review and a manual send.
                            </p>
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">
                                        {{ __('When invoices are marked paid, automatically send a client receipt when the payment state is straightforward. You can still review and send manually from the invoice.') }}
                                    </p>
