    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            @if (!empty($showGettingStartedPrompt))
                <div class="rounded-xl border border-indigo-200 bg-indigo-50 p-5 shadow-sm" style="border-color: currentColor;">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-[0.15em] text-indigo-700">Getting Started</p>
                            <h3 class="mt-1 text-base font-semibold text-indigo-950">Finish your setup flow</h3>
                            <p class="mt-1 text-sm text-indigo-900">Connect a wallet, create an invoice, and send your first share-enabled invoice.</p>
                        </div>
